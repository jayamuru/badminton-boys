...
These credits are also shown in the app, at the foot of your own profile, so the
attribution travels with the build rather than living only in the repo.
...
fonts on their own. None of it constrains the app.
...
| `fonts/outfit-800.woff2` | Outfit | Rodrigo Fuenzalida, Smartsheet |

All are subset to Latin and self-hosted rather than loaded from a CDN — the
